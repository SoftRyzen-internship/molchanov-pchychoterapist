...
export const UtilityCard = ({ name, text, alt }: UtilityCardProps) => {
  const style =
    'w-[114px] h-40 relative -left-4 -bottom-4 md:left-0 md:w-[257.92px] md:h-[362px] md:left-0  xl:bottom-0 block flex-shrink-0';
  return (
    <li className="bg-pinkSupperLight p-4 overflow-hidden rounded-lg flex gap-2  md:p-0 md:gap-14 items-center h-48 md:h-[330px]  xl:h-[362px] xl:w-[610px]">
      {name === 'property-1' && (
