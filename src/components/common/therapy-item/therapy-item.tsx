...
export const TherapyItem: React.FC<TherapyItemProps> = ({
  ...
  return (
    <div className="flex flex-col gap-5 min-h-[208px] md:min-h-[291px] md:gap-9 items-center xl:w-[295px] px-[10px] mdOnly:px-[215px] pb-[22px] mdOnly:pb-[63px] xl:min-h-[218px] xl:pb-0">
      <div
